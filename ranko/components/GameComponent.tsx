...
const mockCharacters = {
  irritating: [
    { name: "Glenn", description: "Katlet sen, boşver gitsin aldırma", image: "/cinderella.jpg" },
    { name: "Derbaş Dermanhan", description: "Bana hiçbir şey olmaz adam", image: "/snow-white.jpg" },
    {
      name: "Reyhan",
      description: "Ölüm",
      image: "/red-riding-hood.jpg",
    },
    ...
    { name: "SevilŞuleNihan", description: "Annanecim", image: "/sevil.jpg" },//+
